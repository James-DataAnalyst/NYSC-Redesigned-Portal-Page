      ...
      {open && (
        <div className="fixed inset-0 z-[9999]">
          ...
          >
            ...
            {/* HEADER */}
            <div className="mb-2 flex items-center justify-between px-2 py-2 border-b border-white/10">
              <h3
            ...
            <div className="space-y-2 overflow-y-auto pr-1 pb-4">
              {notifications.map((item) => (
                <div
                  key={item.id}
                  className={`rounded-2xl p-3 backdrop-blur-md transition-all duration-300 ${
                    isLight
                      ? "bg-slate-50 border border-slate-200 hover:bg-emerald-50"
